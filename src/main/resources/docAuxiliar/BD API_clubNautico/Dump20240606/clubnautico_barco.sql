...
CREATE TABLE `barco` (
  ...
  `num_amarre` int DEFAULT NULL,
  `cuota` double DEFAULT NULL,
  `id_socio` int NOT NULL,
  PRIMARY KEY (`matricula`),
  KEY `FKg7pagqqsmasibi1rekqypgyxr` (`id_socio`),
  CONSTRAINT `FKg7pagqqsmasibi1rekqypgyxr` FOREIGN KEY (`id_socio`) REFERENCES `socio` (`id`)
...
INSERT INTO `barco` VALUES ('1000ZZZZ','Diamante',8,82.5,1);
